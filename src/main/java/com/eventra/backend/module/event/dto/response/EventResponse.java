...
public record EventResponse(
    ...
    public static EventResponse from(Event e, String organizerName, String organizerAvatarUrl, boolean organizerVerified) {
        return from(e, organizerName, organizerAvatarUrl, organizerVerified, null);
    }

    public static EventResponse from(Event e, String organizerName, String organizerAvatarUrl, boolean organizerVerified, String rejectionFeedback) {
